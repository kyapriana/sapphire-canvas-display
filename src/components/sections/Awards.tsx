...
const awards = [
  {
    ...
    org: "Grab",
    year: "2024",
    desc: "Recognized for exceptional contribution and collaboration impact.",
  },
  {
    icon: Award,
    title: "MMA Smarties Award Gold",
    org: "MMA Global",
    year: "2023",
    desc: "O2O/New Retail/Innovative & New Tech Sales Channel campaign with Grab x Molto.",
  },
  {
    icon: Medal,
    ...
    org: "The Drum",
    year: "2025",
    desc: "FMCG Category of Advertising campaign recognition for Grab x Hansaplast.",
  },
  {
    icon: Award,
    title: "MMA Smarties Award Gold",
    org: "MMA Global",
    year: "2025",
    desc: "Brand Purpose/Activism campaign award for Grab x Heineken.",
  },
  {
    icon: Medal,
    title: "MEA Award Bronze",
    org: "Marketing Excellence Awards",
    year: "2025",
    desc: "Excellence in eCommerce Marketing for Grab x Sprite campaign.",
  },
];
